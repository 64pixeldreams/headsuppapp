...
- [docs/story-execution.md](../docs/story-execution.md)
- [docs/cursor-build-loop.md](../docs/cursor-build-loop.md)
...
If a story creates or changes an endpoint, auth rule, event payload, delivery payload, or integration behavior, Cursor must update [docs/api/](../docs/api/README.md) in the same story.

## Current Story Count

There are 122 story files.
...
119 Slack and webhook delivery polish_done
120 Forecast win email template_done
121 Event occurrence watches_done
```
