...
Primary docs: use [quickstart.md](quickstart.md) for setup flow and [reference.md](reference.md) for canonical ingest props. This file keeps connector-specific implementation context.
