...
export function createHeadsUpClient({ baseUrl, apiKey, bootstrapToken, fetch: fetchFn = globalThis.fetch } = {}) {
  ...
  return {
    ...
    updateWatch: (payload) => requestFunction('admin.updateWatch', payload).then((data) => resource(data, 'watch')),
    disableWatch: (payload) => requestFunction('admin.updateWatch', { ...payload, enabled: false }).then((data) => resource(data, 'watch')),
    enableWatch: (payload) => requestFunction('admin.updateWatch', { ...payload, enabled: true }).then((data) => resource(data, 'watch')),
    ...
    deleteSubscriber: (payload) => requestFunction('admin.deleteSubscriber', payload).then((data) => data),
    ...
    traceEvent: (payload) => requestFunction('admin.traceEvent', payload).then((data) => resource(data, 'trace')),
